...
enum AppReviewSampleData {
    ...
    static var homeIntegrations: [HomeIntegration] {
        [
            HomeIntegration(
                id: "sample-local-tasks",
                name: "Local Tasks",
                kind: .custom,
                isEnabled: true,
                ...
                endpoint: nil,
                description: "On-device task list used for App Review screenshots",
            ...
            HomeIntegration(
                ...
                endpoint: nil,
                description: "Local grocery planning with no external account",
                authMethod: .localOnly,
                metadata: [:]
            ),
            HomeIntegration(
                id: "sample-weather",
                name: "Local Weather Brief",
                kind: .weather,
                isEnabled: false,
                ...
                endpoint: nil,
                description: "Optional local forecast placeholder",
                authMethod: .localOnly,
                metadata: [:]
            )
        ]
    ...
    static var homeTasks: [HomeTask] {
        [
            HomeTask(
                id: "sample-task-1",
                title: "Review generated incident summary",
                description: "Confirm the proposed next step before approving any action.",
                status: .inProgress,
                priority: .high,
                dueDate: Date().addingTimeInterval(3_600),
                integrationId: "sample-local-tasks",
                externalId: nil,
                assignedToAgent: true,
                agentSessionId: "sample-agent-reviewer",
            ...
            HomeTask(
                id: "sample-task-2",
                title: "Capture App Review screenshots",
                description: "Use sample mode screens only; avoid live credentials and customer data.",
                status: .pending,
                priority: .normal,
    ...
    static var groceryLists: [GroceryList] {
        [
            GroceryList(
                id: "sample-grocery-list",
                name: "This Week",
                items: [
                    GroceryItem(id: "sample-grocery-1", name: "Oat milk", quantity: "2 cartons", category: .dairy, isBought: false, listId: "sample-grocery-list", addedAt: Date().addingTimeInterval(-3_600), notes: nil, addedByAgent: false),
                    GroceryItem(id: "sample-grocery-2", name: "Sourdough bread", quantity: "1 loaf", category: .bakery, isBought: false, listId: "sample-grocery-list", addedAt: Date().addingTimeInterval(-3_200), notes: nil, addedByAgent: false),
                    GroceryItem(id: "sample-grocery-3", name: "Avocados", quantity: "4", category: .produce, isBought: true, listId: "sample-grocery-list", addedAt: Date().addingTimeInterval(-2_700), notes: nil, addedByAgent: false),
                    GroceryItem(id: "sample-grocery-4", name: "Dish soap", quantity: nil, category: .household, isBought: false, listId: "sample-grocery-list", addedAt: Date().addingTimeInterval(-1_400), notes: nil, addedByAgent: true)
                ],
                createdAt: Date().addingTimeInterval(-7_200),
                integrationId: "sample-groceries"
            )
        ]
    }
